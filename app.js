...
function initShareButton() {
  ...
  button.addEventListener('click', async () => {
    ...
    const prefersNativeShare = !!navigator.share && (window.matchMedia?.('(pointer: coarse)').matches || /Android|iPhone|iPad|iPod/i.test(navigator.userAgent || ''));
...
function renderDataForPlace(place, data, urlSlug, updateHistory = false) {
  ...
  const uvProtectionNote = getUvProtectionNote();
